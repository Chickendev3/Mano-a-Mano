  ...
  <div class="container">
    <div class="wireframe-grid">
      ...
      <div class="col-form" style="max-width: 460px; width: 100%;">
        <h1 class="wireframe-title">Registrarse como organización</h1>
        
        <form action="<?= BASE_URL ?>registro/organizacion" method="POST" id="reg-org-form" style="margin-top: 32px;">
          ...
          <div class="form-group">
            <label for="reg-org-name" class="form-label">Nombre *</label>
          ...
          <div class="form-group">
            ...
            <span class="form-help-text">Debe contener al menos 8 caracteres.</span>
          </div>

          <div class="form-group" style="margin-bottom: 32px;">
            <label for="reg-org-address" class="form-label">Dirección física de la organización *</label>
            <input type="text" id="reg-org-address" name="direccion" class="form-input" placeholder="Calle falsa 123" required>
          </div>
