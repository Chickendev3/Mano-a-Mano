...
<head>
    ...
    <!-- Global CSS -->
    <link rel="stylesheet" href="<?= BASE_URL ?>css/estilos.css?v=7.7">
    ...
    <?php if (isset($cssPropio) && !empty($cssPropio)){
        ...
        <link rel="stylesheet" href="<?= BASE_URL ?>css/<?php echo htmlspecialchars($css); ?>?v=7.7">
    <?php }} ?>
...
<body>
    ...
    <?php if (isset($jsPropio) && !empty($jsPropio)){
        ...
        <script src="<?= BASE_URL ?>js/<?php echo htmlspecialchars($js); ?>?v=7.6"></script>
    <?php }} ?>
