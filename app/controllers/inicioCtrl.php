...
class inicioCtrl extends Controlador {
    ...
    public function index() : void {
        ...
        $campanas = [
            ...
            [
                'id' => 13,
                'titulo' => 'Cuidado de Senderos',
                'org' => 'EcoRed',
                'categoria' => 'medio-ambiente',
                'categoria_label' => 'Medio Ambiente',
                'badge_clase' => 'badge-env',
                'descripcion' => 'Ayudanos a restaurar y señalizar los senderos del Parque Reserva Natural para proteger la flora autóctona.',
                'registrados' => 6,
                'requeridos' => 10,
                'progreso' => 60,
                'ubicacion' => 'Mendoza',
            ...
            [
                ...
                'categoria_label' => 'Educación',
                'badge_clase' => 'badge-edu',
                'descripcion' => 'Buscamos voluntarios para realizar lecturas compartidas y dinámicas de comprensión de textos con niños de primaria.',
                'registrados' => 3,
                'requeridos' => 5,
                'progreso' => 60,
                'ubicacion' => 'Salta',
            ...
            [
                'id' => 15,
                'titulo' => 'Pintura Solidaria',
                'org' => 'Corazones Abiertos',
                'categoria' => 'accion-social',
                'categoria_label' => 'Acción Social',
                'badge_clase' => 'badge-soc',
                'descripcion' => 'Sumate a pintar y refaccionar las salas del club deportivo barrial que asiste a más de 200 jóvenes.',
                'registrados' => 12,
                'requeridos' => 15,
                'progreso' => 80,
                'ubicacion' => 'La Plata',
            ...
            [
                ...
                'categoria_label' => 'Educación',
                'badge_clase' => 'badge-edu',
                'descripcion' => 'Buscamos tutores para dictar clases básicas de lectura, escritura y cálculo a adultos mayores del centro vecinal.',
                'registrados' => 4,
                'requeridos' => 8,
                'progreso' => 50,
                'ubicacion' => 'Córdoba',
            ...
            [
                'id' => 17,
                'titulo' => 'Refugio de Noche',
                'org' => 'Corazones Abiertos',
                'categoria' => 'accion-social',
                'categoria_label' => 'Acción Social',
                'badge_clase' => 'badge-soc',
                'descripcion' => 'Colaborá en la recepción de personas en situación de calle, sirviendo la cena y acondicionando las camas.',
                'registrados' => 5,
                'requeridos' => 10,
                'progreso' => 50,
                'ubicacion' => 'Rosario',
